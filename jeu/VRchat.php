...
<main>
    ...
    <section class="container mt-3">
        ...
        <div class="d-flex justify-content-start bg-light">
            <div>
                <img src="../assets/images/jeu/VRchat.jpg" style="width: 550px" class="m-3 mt-4">
            </div>
            <div class="d-flex flex-column mb-3 mx-5">

                <div> <h1 class="m-3 text-center">VRchat</h1></div>

                <div class="text-center m-3">Rejoignez notre communauté grandissante en explorant, en jouant et en contribuant
                    à façonner l'avenir de la réalité virtuelle sociale. Créez des mondes et des avatars personnalisés.
                    <br> Bienvenue sur VRChat.</div>
