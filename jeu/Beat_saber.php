...
<main>
    ...
    <section class="container mt-3">
        ...
        <div class="d-flex justify-content-start bg-light">
            <div>
                <img src="../assets/images/jeu/beat-saber.jpeg" style="width: 550px" class="m-3 mt-4">
            </div>
            <div class="d-flex flex-column mb-3 mx-5">

                <div> <h1 class="m-3 text-center">Beat Saber</h1></div>

                <div class="text-center m-3">Beat Saber est un jeu de rythme en VR où vous devez trancher les notes d'une
                    musique entraînante qui arrivent vers vous, au sein d'un univers futuriste. </div>
                ...
                <div class="mt-auto p-2">
                    <div class="d-flex justify-content-evenly">
                        ...
                        <div> date de sortie : 28/12/2022 </div>
