    ...
    <section class="container mt-3">
        ...
        <div class="d-flex justify-content-start bg-light">
            ...
            <div class="d-flex flex-column mb-3 mx-5">
                ...
                <div> <h1 class="m-3 text-center">Vegas Infinite</h1></div>

                <div class="text-center m-3">Vegas Infinite est un monde de divertissement sans limites.
                    Plongez dans la réalité virtuelle ou asseyez-vous et jouez sur PC sans casque requis.
                    Affrontez la maison au blackjack et à la roulette pleins d'action. Allumez les dés avec vos amis au craps.</div>
                ...
                <div class="mt-auto p-2">
                    <div class="d-flex justify-content-evenly">
                        ...
                        <div> date de sortie : 14/07/2021 </div>
